...
d = st.date_input("Enter a date in month/year format:", value=datetime.today(), format="MM/YYYY")
e = st.date_input("Enter a date in month/year format:", value=datetime.today(), format="MM/YYYY")
